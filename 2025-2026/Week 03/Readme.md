# OOП - Практикум 05.03.2026 - Седмица 3

**Задача 1.**
Да се напише функция, която чете числа от двоичен файл и записва само простите числа във файл с име "primes.bin".

**Задача 2.** 

Да се напише структура, който съхранява информация за доставка на пица. Да се създаде масив от доставки - списък с поръчки. Една поръчка съдържа:

*  име на клиента (до 50 символа);
* телефонен номер (до 20 символа);
* адрес на потребителя(до 100 символа);
* общата стойност на доставката;
* броят пици;
* масив от пици.

 Структурата на пицата трябва да съдъжа:
 * типа на пицата { Маргарита, калцоне, бурата и каквато още пожелаете};
 * размер на пицата {S,M,L};
 * цена на пицата. 
 
 Да се имплементират функции, които позволяват съхраняването и изчитането на информацията за поръчките от двоичен файл. Да се сортират поръчките в масива по адрес на доставка и да се запише в нов двоичен файл.
...
Създайте структура, описващ обява за работа. Класът трябва да съдържа:
