# ООП - Практикум 19.03.2025 - Седмица 5
...
- Метод, който сортира Картите Чудовища по подадена сравняваща функция на две карти чудовища
  -Метод, който сортира Магическите карти по подадена сравняваща функция на две магически карти
